  ...
  handleClick = () => {
    ...
    return isFound && isFound2
      ? this.props.history.push({
          pathname: `/compare/${this.state.childUserinput1}/${
            this.state.childUserinput2
          }/`,
          state: {
            cities: [
              this.state.childUserinput1,
              this.state.childUserinput2,
              this.props.cities
            ]
          }
        })
      : window.alert("Please select 2 valid cities");
        ...
        <div className="homepage-container">
          <div>
            <AutoComplete
              ...
              getData={this.getDropdownCities}
            />
          </div>
          <div>
            <AutoComplete
              cities={this.props.cities}
              getData={this.getDropdownCities2}
            />
          </div>
        </div>
